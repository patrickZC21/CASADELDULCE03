    ...
    <div class="form-group">
        ...
        <textarea name="especificaciones_en" class="form-control" rows="4" placeholder=""></textarea>
                ...
                <select name="id_categoria" class="form-control">
                    ...
                    <?php
                    // Aquí deberías tener el código para obtener los registros de tu tabla de categorías
                    // y almacenarlos en una variable llamada $categorias

                    // Ejemplo de cómo podrías obtener las categorías desde la base de datos usando MySQLi
                  
                    $query = "SELECT id, nombre_es FROM categorias";
                    $result = $conexion->query($query);

                    // Iterar sobre los registros y generar las opciones del select
