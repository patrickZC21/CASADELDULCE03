...
<body id="page-top">
    ...
    <form method="post" action="subcategoria-insertar.php" enctype="multipart/form-data">
                ...
                <div class="col">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">nombre de la nueva subcategoria</h6>
                        </div>
                        <div class="card-body">
